...
// Возвращает корневой каталог репозитория
//
//  Возвращаемое значение:
//   Строка - Путь к корневому каталогу репозитория
//
Функция КорневойКаталог() Экспорт

    ПараметрыЗапуска = Новый Массив;
    ПараметрыЗапуска.Добавить("rev-parse");
    ПараметрыЗапуска.Добавить("--show-toplevel");
